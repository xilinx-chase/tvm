...
def get_tags(pr_data: Dict[str, Any], github: GitHubRepo, team_issue: int) -> str:
    ...
    description = "<sub>See [#10317](https://github.com/apache/ssuxue/issues/2) for details</sub>"
    if len(to_cc) == 0:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--team-issue", default="2", help="issue number to look at for ccs")
    parser.add_argument(
